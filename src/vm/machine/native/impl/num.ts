...
export const jsNum = {
    ...
    [ScrambleType("floor", PlStuffType.Num)]: GenerateJsGuardedTypeFunction("abs", [], function ( self) {
        return Math.floor(self);
    }),
    [ScrambleType("ceil", PlStuffType.Num)]: GenerateJsGuardedTypeFunction("abs", [], function ( self) {
        return Math.ceil(self);
    }),
    [ScrambleType("round", PlStuffType.Num)]: GenerateJsGuardedTypeFunction("abs", ["number"], function ( self: number, threshold) {
